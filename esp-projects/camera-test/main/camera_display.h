...
typedef enum {
    ...
    CAMERA_DISPLAY_STATUS_BRAKE,
    CAMERA_DISPLAY_STATUS_AVOID_LEFT,
    CAMERA_DISPLAY_STATUS_AVOID_FORWARD,
    CAMERA_DISPLAY_STATUS_AVOID_RIGHT,
    CAMERA_DISPLAY_STATUS_T_FINISH,
...
typedef struct {
    ...
    int ultrasonic_cm;
    bool finish_enabled;
    unsigned finish_frames;
    unsigned finish_required_frames;
