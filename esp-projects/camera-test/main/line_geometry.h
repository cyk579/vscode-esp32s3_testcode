...
#define LINE_NEAR_BOTTOM_PERCENT 82
#define LINE_ROW_STEP 2
#define LINE_BOTTOM_SKIP_ROWS 0
#define LINE_SCAN_MAX_ROWS 64
#define LINE_SEARCH_HALF_PERCENT 30
#define LINE_SEARCH_HALF_MIN 8
#define LINE_SEARCH_HALF_MAX 80
/* 逐行搜索用上一行的斜率做预测；给急弯留出较宽的跳变容错。 */
#define LINE_MAX_CENTER_JUMP_PERCENT 20
#define LINE_MIN_SEGMENT_WIDTH 2
#define LINE_MAX_SEGMENT_WIDTH_PERCENT 65
#define LINE_MIN_VALID_ROWS 2
#define LINE_CORNER_MIN_VALID_ROWS 1
#define LINE_SEED_MISS_ROWS 8
#define LINE_MAX_TRACK_MISSES 3
